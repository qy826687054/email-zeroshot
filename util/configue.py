...
DEFAULT_CONFIGURE_DIR = r"D:\python\ms-project\CoSDA-ML-master\configure"
DEFAULT_DATASET_DIR = r"D:\python\ms-project\CoSDA-ML-master\dataset"
DEFAULT_MODEL_DIR = r"D:\python\ms-project\CoSDA-ML-master\model"
DEFAULT_EXP_DIR = r"D:\python\ms-project\CoSDA-ML-master\exp"
    ...
    def get_con(default_file):
        ...
        for arg_name, arg in args_label:
            ...
            if arg.type == "string" or arg.type == "str" or arg.type is None:
                if arg.default:
                    if arg.default == "None" or arg.default == "none":
                        argw["default"] = None
                    else:
